class Component extends DCLogic {
    ...
    lookupVisitor() {
        ...
        const apply = (d, host) => {
            ...
            this.setState({
                ...
                vNote: "# you ran this. your IP address went to " + host + ", which logs queries for a limited time; the map tiles came from openstreetmap.org. nothing was written to your device, and the only thing that reaches me is a page count, from cloudflare."
            });
    ...
    renderVals() {
        return {
            ...
            trackNote: this.state.vRan ? "1 lookup, on your command · utf-8" : "no cookies · cf analytics · utf-8",
